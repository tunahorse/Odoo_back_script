...
backup_cmd = 'odoo-bin -d {} -o -r admin -w admin --db_host=localhost --db_port=5432 --db_user=odoo --db_password=odoo --addons-path=../odoo/addons -r admin -w admin -b {} -f {}'.format(db_name, backup_dir, backup_file)
